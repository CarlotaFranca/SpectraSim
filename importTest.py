...
try:
    ...
    print('\033[92m' + "Custom Tkinter imported correctly!" + '\033[0m')
except:
    print('\033[91m' + "Error importing Custom Tkinter!" + '\033[0m')

try:
    from CTkMessagebox import CTkMessagebox
    print('\033[92m' + "CTk messagebox imported correctly!" + '\033[0m')
except:
    print('\033[91m' + "Error importing CTk messagebox!" + '\033[0m')

try:
    from CTkListbox import CTkListbox
    print('\033[92m' + "CTk ListBox imported correctly!" + '\033[0m')
except:
    print('\033[91m' + "Error importing CTk ListBox!" + '\033[0m')
